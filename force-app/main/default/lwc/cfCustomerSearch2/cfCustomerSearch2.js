/** 
    ...
    //release 3
    1.3   09/12/2024   Rakeyan Nuramria                  [FROM SIT] UST-042, Add capability Search by Phone Number in Banking Logic + cleansing code
    1.3   13/12/2024   Rakeyan Nuramria                  [FROM SIT] Adjust for validation phone number kredit method
    1.3   08/01/2025   Rakeyan Nuramria                  Adjust for validation phone number banking method
    1.3   20/01/2025   Rakeyan Nuramria                  UST-017 - Add capability search by Id Outlet
    **/
...
export default class cfCustomerSearch2 extends NavigationMixin(LightningElement) {
    ...
    //newly added [09/12/2024] for r3 - search banking by phone number
    @track phoneNumberBanking = '';
    @track disablePhoneNumberBankingField = false;
    phoneNumberBankingError = '';
    //end newly added [09/12/2024]
    ...
    disableFields(disable) {
        ...
        this.disablePhoneNumberBankingField = disable;
    }
    ...
    handlePhoneNumberBanking(event) {
        this.clearErrorsAndResults();
        this.phoneNumberBanking = event.target.value;
        this.phoneNumber = '';
        this.accountNumber = '';
        this.debitCardNumber = '';
        this.idValue = '';
        ...
        this.validatePhoneNumber(this.phoneNumberBanking, 'phoneNumberBankingError');
        this.toggleFields('phoneNumberBanking');
        if (!this.phoneNumberBanking) {
            this.clearInputFields();
            this.clearErrorsAndResults();
        }
    }
    ...
    handlePhone(event) {
        ...
        this.merchantMID = '';
        this.dplkNumber = '';
        this.validatePhoneNumberKredit();
    ...
    toggleFields(inputField) {
        if (inputField === 'account') {
            ...
            this.disablePhoneNumberBankingField = !!this.accountNumber;
            ...
            this.disablePhoneNumberBankingField = !!this.debitCardNumber;
            ...
            this.disablePhoneNumberBankingField = !!this.idValue;
            ...
            this.disablePhoneNumberBankingField = !!this.tipeId;
        ...
        } else if (inputField === 'phoneNumberBanking'){
            this.disableAccountField = !!this.phoneNumberBanking;
            this.disableDebitCardField = !!this.phoneNumberBanking;
            this.disableCreditCardField = !!this.phoneNumberBanking;
            this.disableIdField = !!this.phoneNumberBanking;
            this.disablePhoneField = !!this.phoneNumberBanking;
            this.disableTipeIdField = !!this.phoneNumberBanking;
            this.disableBrilinkTIDField = !!this.phoneNumberBanking;
            this.disableBrilinkMIDField = !!this.phoneNumberBanking;
            this.disableOutletIDField = !!this.phoneNumberBanking;
            this.disableMerchantTIDField = !!this.phoneNumberBanking;
            this.disableMerchantMIDField = !!this.phoneNumberBanking;
        }
    }
    ...
    validatePhoneNumberKredit() {
        const phoneRegex = /^[0-9]{10,14}$/;
        if (!phoneRegex.test(this.phoneNumber)) {
            this.phoneNumberError = 'Nomor Telepon harus terdiri dari 10 hingga 14 digit angka, tanpa huruf atau karakter lainnya.';
        }
    }

    //v2 using parameter for the value and what error message that should be show
    validatePhoneNumber(phoneValue, errorField) {
        
        // Regex that ensures only digits & 10 - 14 length
        const phoneRegex = /^[0-9]{10,14}$/;
        if (!phoneRegex.test(phoneValue)) {
            this[errorField] = 'Nomor Telepon harus terdiri dari 10 hingga 14 digit angka, tanpa huruf atau karakter lainnya.';
        }
    ...
    handleSearchBanking() {
        ...
        const requestPayload = {
            ...
            cifNo: '' || null,
            phoneNumber: this.phoneNumberBanking || null,
