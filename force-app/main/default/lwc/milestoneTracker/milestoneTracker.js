...
export default class milestoneTrackerTracker extends LightningElement {
    ...
    wiredResult(value) {
        ...
        if (data) {
            // console.log('Formatted JSON Data:', JSON.stringify(data, null, 2)); // Lebih mudah dibaca
    ...
    initializeSla(data) {
        ...
        this.milestones = data.map(milestone => {
            ...
            console.log('milestone targetresponseinMins: ' + milestone.targetResponseInMins);
            // console.log("milestone targetResponseInMins: " + milestone.targetResponseInMins);
            // console.log('TARGET IN HARI : ' + targetTimeInDays);
            ...
            // console.log('milestone name: ' + milestone.milestoneName)
    ...
    formatDurationInDays(milliseconds) {
        console.log('mili seconds:' + milliseconds);
        const totalSeconds = Math.floor(milliseconds / 1000);
    ...
    // Jika ada requirements ingin tampilan dalam jam juga
    // formatDurationInDays(milliseconds) {
    //     const totalSeconds = Math.floor(milliseconds / 1000);
    //     const days = Math.floor(totalSeconds / (3600 * 24));
    //     if (days < 1) {
    //         const hours = Math.floor((totalSeconds / 3600) /3);
    //         return `${hours} Jam`;
    //     }
    //     return `${days} Hari`;
    // }
