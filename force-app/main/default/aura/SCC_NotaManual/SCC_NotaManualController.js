        ...
        action.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS") {
                ...
                component.set("v.notaManual", {
                    ...
                    'SCC_Branchcode__c': caseDetails.Terminal_ID__r.SCC_Branch_Code__c,
                    'SCC_Keterangan__c': '',
                    'SCC_Rekening_Titipan__c': caseDetails.Terminal_ID__r.SCC_Account_Number__c,
                    ...
                    'SCC_Terminal_ID__c': caseDetails.SCC_Terminal_ID__c 
                });
            } else {
